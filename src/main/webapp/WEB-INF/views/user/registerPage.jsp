...
<link
	href="${pageContext.request.contextPath}/resources/css/jeabbom.css"
...
<body class="body">
	...
	<div id="register_agree" class="serviceboard container-6 w-container">
		<h1 class="heading-9">약관 동의</h1>
		<form name="fregister" id="fregister"
			onsubmit="return fregister_submit(this);" method="post"
			action="${pageContext.request.contextPath}/user/joinPage.do"
			autocomplete="off">
			<div id="fregister_chkall" class="textofuserinfo">
				<label for="chk_all"> 회원가입 약관에 모두 동의합니다<input
					type="checkbox" name="chk_all" value="1" id="chk_all">
				</label>
			</div>
			<hr>
			<section id="fregister_term">
				<div class="textofuserinfo">
					<label for="agree11"> 이용약관 동의 <span>(필수)</span><input
  ...
  ② “몰”과 이용자 간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
			...
			<section id="fregister_private">
				<fieldset class="fregister_agree2 checks2">
					<div class="textofuserinfo">
						<label for="agree21"> 기인정보 수집 및 이용 동의 <span>(필수)</span><input
...
1) 공고일자 : 2021년 06월 01일
2) 시행일자 : 2021년 06월 01일 
			</textarea>
			</section>
			<div class="userinfobuttenblock">
				<a href="${pageContext.request.contextPath}/"
					class="loginbutten w-button">취소</a> <input type="submit"
					class="loginbutten w-button" value="회원가입" id="btn_submit">
			</div>
		</form>
		<script>
			function fregister_submit(f) {
				if($("input:checkbox[name=agree]").prop("checked") == false){
					alert("회원가입약관의 내용에 동의하셔야 회원가입을 하실 수 있습니다.");
					f.agree.focus();
					return false;
				}
				if($("input:checkbox[name=agree2]").prop("checked") == false){
					alert("개인정보처리방침안내의 내용에 동의하셔야 회원가입을 하실 수 있습니다.");
					f.agree2.focus();
					return false;
				}
				return true;
			...
			$("#chk_all").click(function(){
				if($("input:checkbox[name='chk_all']").prop("checked")){
